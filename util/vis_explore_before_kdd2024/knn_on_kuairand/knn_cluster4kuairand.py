...
diff_train_lst100 = find_topK_to_compare(train_mat, train_mat, 100, train_mat, gt_mat) # np.mean(diff_train_lst100)=0.9745
diff_train_lst1000 = find_topK_to_compare(train_mat, train_mat, 1000, train_mat, gt_mat) # np.mean(diff_train_lst1000)=0.9934
