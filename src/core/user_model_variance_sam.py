...
class UserModel_Variance_SAM(nn.Module):
    def __init__(self, feature_columns, y_columns,
        ...
        super(UserModel_Variance_SAM, self).__init__()
    ...
    def fit_data(self, dataset_train, dataset_val=None, batch_size=256, epochs=1, verbose=1, initial_epoch=0,
        ...
        # Train
        sam_optim = SAM(self.parameters(), base_optimizer=torch.optim.Adam)
