...
# class EnsembleModel():
#     def __init__(self, num_models, message, MODEL_SAVE_PATH, remark, *args, **kwargs):
#         # print("args", args)
#         self.user_models = [UserModel_Pairwise_Variance(*args, **kwargs) for i in range(num_models)]

#         self.MODEL_SAVE_PATH = MODEL_SAVE_PATH
#         self.PREDICTION_MAT_PATH = os.path.join(MODEL_SAVE_PATH, "matsPre", f"[{message}]_matPre_{remark}.pickle")
#         self.VAR_MAT_PATH = os.path.join(MODEL_SAVE_PATH, "matsVar", f"[{message}]_matVar_{remark}.pickle")
#         self.Entropy_PATH = os.path.join(MODEL_SAVE_PATH, remark, "entropy")
#         self.MODEL_PARAMS_PATH = os.path.join(MODEL_SAVE_PATH, "params", f"[{message}]_params_{remark}.pickle")
#         self.MODEL_PATH = os.path.join(MODEL_SAVE_PATH, "models", f"[{message}]_model_{remark}.pt")
#         self.MODEL_EMBEDDING_PATH = os.path.join(MODEL_SAVE_PATH, "embeddings",
#                                                  f"[{message}]_emb_{remark}.pt")  # todo: deprecated
#         self.USER_EMBEDDING_PATH = os.path.join(MODEL_SAVE_PATH, "embeddings", f"[{message}]_emb_user_{remark}.pt")
#         self.ITEM_EMBEDDING_PATH = os.path.join(MODEL_SAVE_PATH, "embeddings", f"[{message}]_emb_item_{remark}.pt")
#         self.USER_VAL_EMBEDDING_PATH = os.path.join(MODEL_SAVE_PATH, "embeddings", f"[{message}]_emb_user_val_{remark}.pt")
#         self.ITEM_VAL_EMBEDDING_PATH = os.path.join(MODEL_SAVE_PATH, "embeddings", f"[{message}]_emb_item_val_{remark}.pt")
