...
## used to for test after kdd2024Feb, now for cikm2024.
...
def knn_based_pred_reward(env, kr, ku, uncertain_type):
    if env == 'KuaiEnv-v0':
...
if __name__ == '__main__':
    rand_r_mat, rand_var_mat = knn_based_pred_reward("KuaiRand-v0", 5, 5, 'II-weight-norm')
    # rec_r_mat, rec_var_mat = knn_based_pred_reward("KuaiEnv-v0", 5, 5, 'II-weight-norm')