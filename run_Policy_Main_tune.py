...
from pre_utils import knn_based_pred_reward
...
def prepare_envs(args, config, ensemble_models, alpha_u=None, beta_i=None):
    ...
    if args.change_pred_reward or args.change_var:
        knn_based_reward, knn_based_var = knn_based_pred_reward(args.env)
    else:
...
def main(args):
    ...
    # %% 1. Prepare the saved path.
        ...
        env, train_envs, test_envs_dict = prepare_envs(args, wandb.config, ensemble_models)
